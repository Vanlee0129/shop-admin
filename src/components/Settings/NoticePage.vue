  ...
  <div class="content-page">
    <div class="content-nav">
      ...
      <div class="operation-nav">
        ...
        <el-button type="primary" icon="plus" @click="addNotice"
          >添加公告</el-button
        >
      </div>
    </div>
    ...
    <el-dialog :title="is_add ? '添加' : '编辑'" :visible.sync="dialog">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="goNotice" v-if="is_add"
          >确定添加</el-button
        >
        <el-button type="primary" @click="updateNotice" v-if="!is_add"
          >确定修改</el-button
        >
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    submitContent(index, row) {
      this.axios
        .post("notice/updateContent", { id: row.id, content: row.content })
        .then(() => {});
    },
