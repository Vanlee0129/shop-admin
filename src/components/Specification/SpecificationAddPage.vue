    ...
    <div class="content-main">
      <div class="form-table-box">
        ...
        >
          ...
          <el-form-item>
            <el-button v-if="infoForm.id > 0" type="primary" @click="updateSpec"
              >确定保存</el-button
            >
            <el-button v-else type="primary" @click="addSpec"
              >确定添加</el-button
            >
            <el-button v-if="infoForm.id > 0" type="danger" @click="specDelete"
              >删除</el-button
            >
