      ...
      <div class="form-table-box">
        ...
        >
          ...
          <el-form-item>
            ...
            <el-button type="danger" class="float-right" @click="onCopyGood"
              >复制商品</el-button
            >
...
export default {
  ...
  methods: {
      ...
      this.$refs["infoForm"].validate((valid) => {
        if (valid) {
          if (this.infoForm.index_pic_position > 0) {
            if (
              this.infoForm.index_pic_url == "" ||
              this.infoForm.index_pic_url == null
            ) {
              this.$message({
                type: "error",
                message: "请上传特色图片或选择无",
    ...
    handleUploadListSuccess(res) {
      ...
      this.axios
        .post("goods/uploadHttpsImage", { url: this.infoForm.list_pic_url })
        .then((response) => {
