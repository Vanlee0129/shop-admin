      ...
      <div class="form-table-box">
        ...
        >
          <el-form-item label="广告图片" prop="image_url">
            ...
            >
              <el-button v-if="!infoForm.image_url" size="small" type="primary"
                >点击上传</el-button
              >
            </el-upload>
                ...
                <el-table-column label="操作">
                  <template scope="scope">
                    <el-button
                      size="small"
                      type="danger"
                      @click="relateSelect(scope.row.id)"
                      >选择
                    </el-button>
                  </template>
                </el-table-column>
