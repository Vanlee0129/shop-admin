  ...
  <div class="content-page">
    ...
    <el-dialog title="打印快递单" :visible.sync="dialogFormVisible">
      <el-form :model="dform">
        <div class="dialog-wrap">
          <div class="list-wrap">
            <div
              class="goods-list"
              v-for="(ditem, index) in orderInfo.goodsList"
              :key="index"
            >
          ...
          <div v-if="orderInfo.admin_memo != ''" class="user-admin-t">
      ...
      <div slot="footer" class="dialog-footer print-footer">
        <div class="f-left">
          <el-checkbox
            v-if="isShow && orderInfo.order_status == 300"
...
import ElButton from "../../../node_modules/element-ui/packages/button";
